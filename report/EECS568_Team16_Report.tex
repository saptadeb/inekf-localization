...
G_{12} = \left( \mathbf{I} + \left( {\boldsymbol \xi}_t^R \right)^{\wedge} \right) \tilde{\mathbf{a}}_t + \mathbf{g} -\tilde{\boldsymbol \omega}_t^{\wedge} {\boldsymbol \xi}_t^v, \hspace{1.4cm} \\
G_{13} = {\boldsymbol \xi}_t^v - \tilde{\boldsymbol \omega}_t^{\wedge} {\boldsymbol \xi}_t^p. \hspace{4.1cm}
\end{multline}
...
\left( \mathbf{I} + \left( {\boldsymbol \xi}_t^R \right)^{\wedge} \right) \tilde{\mathbf{a}}_t + \mathbf{g} -\tilde{\boldsymbol \omega}_t^{\wedge} {\boldsymbol \xi}_t^v \\
